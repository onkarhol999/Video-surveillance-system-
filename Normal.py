...
# Usage example:
folder_path = "./Dataset/NormalVideo"  # Folder where your videos are stored
output_csv = 'Normal_video_frames_labels.csv'  # Output CSV file
frames_output_folder = './Frames/NormalVideoFrames'  # Folder where frames will be saved
